...
void TSD_GFX::fillRectVGradient(int16_t x, int16_t y, int16_t w, int16_t h, gradient_t& z)
{
  int16_t r1, g1, b1;
...
void TSD_GFX::fillRectHGradient(int16_t x, int16_t y, int16_t w, int16_t h, gradient_t& z)
{
  int16_t r1, g1, b1;
  RGB14fromColor(z.color1, r1, g1, b1);
  int16_t r2, g2, b2;
