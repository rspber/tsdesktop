...
void setup(void) {
  tft.init();
  tft.fillScreen(BLACK); // Background is black
}
...
//  tft.setCursor(0, 0);
  ...
  for (int i = 0; i < 20; i++)
  {
    ...
    tft.drawSmoothRoundRect(x, y, radius, radius - t, w, h, random(0x10000), BLACK);
  }
  tft.drawText(0, 0, "Variable thickness");
  delay(2000);
...
//  tft.setCursor(0, 0);
  ...
  tft.drawText(0, 0, "Minimum thickness");
  delay(2000);
}
