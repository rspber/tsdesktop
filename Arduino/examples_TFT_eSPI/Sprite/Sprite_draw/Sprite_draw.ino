...
void loop(void)
{
  ...
  // Draw some lines
  spr.drawLine(1, 0, WIDTH, HEIGHT-1, GREEN);
  spr.drawLine(0, 0, WIDTH, HEIGHT, GREEN);
  spr.drawLine(0, 1, WIDTH-1, HEIGHT, GREEN);
  spr.drawLine(0, HEIGHT-1, WIDTH-1, 0, RED);
  spr.drawLine(0, HEIGHT, WIDTH, 0, RED);
  spr.drawLine(1, HEIGHT, WIDTH, 1, RED);
...
//  spr.setTextDatum(MC_DATUM);
  ...
  spr.drawRect(0, 0, WIDTH, HEIGHT, BLUE);
