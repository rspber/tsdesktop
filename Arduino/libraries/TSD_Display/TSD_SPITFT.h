...
/*!
  @brief  TSD_SPITFT is an intermediary class between Adafruit_GFX
          ...
          the comments.
*/
class TSD_SPITFT : public TSD_GFX {
...
public:
  ...
  TSD_SPITFT(int8_t cs, int8_t dc, int8_t mosi, int8_t sck, int8_t rst = -1,
			 int8_t miso = -1);
  ...
  TSD_SPITFT(int8_t cs, int8_t dc, int8_t rst = -1);
  ...
  TSD_SPITFT(SPIClass *spiClass, int8_t cs, int8_t dc, int8_t rst = -1);
#endif // end !ESP8266
  ...
  TSD_SPITFT(tftBusWidth busWidth, int8_t d0, int8_t wr, int8_t dc,
  ...
  */
  ...
  void writePixels(const rgb_t *colors, uint32_t len, bool block = true,
				   bool bigEndian = false);
  void writeColor(rgb_t color, uint32_t len);
  void writeFillRect(clip_t* clip, int16_t x, int16_t y, int16_t w,
					 int16_t h, rgb_t color);
  void writeFastHLine(clip_t* clip, int16_t x, int16_t y, int16_t w,
					  const rgb_t color);
  void writeFastVLine(clip_t* clip, int16_t x, int16_t y, int16_t h,
					  const rgb_t color);
  ...
  void drawPixel(clip_t* clip, int16_t x, int16_t y, const rgb_t color);
  void fillRect(clip_t* clip, int16_t x, int16_t y, int16_t w, int16_t h,
				const rgb_t color);
  void drawFastHLine(clip_t* clip, int16_t x, int16_t y, int16_t w,
					 const rgb_t color);
  void drawFastVLine(clip_t* clip, int16_t x, int16_t y, int16_t h,
					 const rgb_t color);
  ...
  void pushColor(const rgb_t color);

  using TSD_GFX::drawRGBBitmap; // Check base class first
  void drawRGBBitmap(clip_t* clip, int16_t x, int16_t y,
