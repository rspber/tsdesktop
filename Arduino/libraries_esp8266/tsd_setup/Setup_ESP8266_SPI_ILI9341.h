/*
  User setup for ESP8266 SPI ILI9341 with touch
*/
...
// SPI
  #define TFT_SPI_CLK     5
  #define TFT_SPI_MISO    6
  #define TFT_SPI_MOSI    7
  #define TFT_SPI_CS      8    // SS - chip select control pin
  #define TFT_SPI_DC      3    // Data Command control pin
  #define TFT_SPI_RST     4    // Reset pin
