...
#include <ESP32_TFT_SPI.h>
  ...
  #if (TOUCH_SPI_CS >= 32)
    #define TOUCH_SPI_CS_L    SPI_32_PIN_LOW(TOUCH_SPI_CS);   SPI_32_PIN_LOW(TOUCH_SPI_CS)
    #define TOUCH_SPI_CS_H    SPI_32_PIN_HIGH(TOUCH_SPI_CS)
  #elif (TOUCH_SPI_CS >= 0)
    #define TOUCH_SPI_CS_L    SPI_00_PIN_LOW(TOUCH_SPI_CS);   SPI_00_PIN_LOW(TOUCH_SPI_CS)
    #define TOUCH_SPI_CS_H    SPI_00_PIN_HIGH(TOUCH_SPI_CS)
  #else
