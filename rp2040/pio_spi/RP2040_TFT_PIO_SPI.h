...
#pragma once
  ...
  typedef struct
  {
    ...
    void load_program();
    void init();
    void setClockDiv(const uint8_t clock_div);
    ...
    uint32_t instr_jmp_read8;
    inline void START_READ_8() { pio_sm->instr = instr_jmp_read8; }
#endif
  ...
  extern p_pio_t pio_spi_0;

  #define PIO_WAIT_FOR_STALL pio_spi_0.WAIT_FOR_STALL()

  #if defined(TFT_SPI_CS) && (TFT_SPI_CS >= 0)
    #define PIO_CS_L sio_hw->gpio_clr = (1ul << TFT_SPI_CS)
    #define PIO_CS_H PIO_WAIT_FOR_STALL; sio_hw->gpio_set = (1ul << TFT_SPI_CS)
  #else
    #define PIO_CS_L
    #define PIO_CS_H
  #endif
  ...
  #define PIO_START_SEND_8  pio_spi_0.START_SEND_8()
  #define PIO_START_SEND_16 pio_spi_0.START_SEND_16()
  #define PIO_START_SEND_24 pio_spi_0.START_SEND_24()
  #define PIO_START_CHUNK   pio_spi_0.START_CHUNK()

  #define PIO_WAIT_FOR_FIFO_FREE(S) WAIT_FOR_FIFO_FREE(pio_spi_0.pio, pio_spi_0.sm, S)
//  #define PIO_WAIT_FOR_FIFO_5_FREE WAIT_FOR_FIFO_5_FREE(pio_spi_0.pio, pio_spi_0.sm)
