...
public:
  ...
  */
  ...
  void drawChar(cursor_t *cursor, font_t *font, const char c, const uint16_t color);
  void drawTextLine(cursor_t *cursor, font_t *font, const char *text, const uint16_t color = WHITE, const int8_t spacing = 0);
